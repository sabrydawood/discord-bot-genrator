...
import { Language, PackageManagerType, GenratorConfig, StructureType } from "./types"
...
export interface ProjectScaffolder {
 ...
 createCommand(genratorFilePath: string): Promise<void>
 createEvent(genratorFilePath: string): Promise<void>
 createDatabase(genratorFilePath: string): Promise<void>
}
...
export interface ProjectPrompter {
 ...
 database(prompt: Array<PromptObject>): Promise<any>
...
export interface ProjectTemplateGenerator {
 ...
 generateDatabase(database: any[], databaseDir: string): void
...
export interface FileSystemManager {
 ...
 createConfig(config: GenratorConfig): void
 ...
 getFileToJson(filePath: string): Promise<GenratorConfig>
