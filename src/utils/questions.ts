...
export const questions: Array<PromptObject> = [
 ...
 },
 {
  ...
  choices: [
   ...
   { title: "Database", value: "database", description: "Generate an database model?" },
  ],
 },
]
  ...
  choices: [
   {
    title: "Latest",
    value: "latest",
    description: "Install the latest version of Discord.JS v14",
   },
   {
    title: "v13.6.4",
    value: "13.6.4",
    description: "Install Discord.JS v13.6.4",
   },
  ],
 },
]
...
export const getCredentials: Array<PromptObject> = [
 ...
 },
 {
  type: "text",
  name: "mongo_uri",
  message: "Enter your MONGO_CONNECTION Uri",
  validate: (value: string) => (value.length === 0 ? "Cannot be empty" : true),
 },
]
...
export const databaseGenerate: Array<PromptObject> = [
 {
  type: "autocompleteMultiselect",
  name: "databases",
  message: "Which database(s) would you like to generate?",
  choices: [
   {
    title: "Guild",
    value: "Guild",
